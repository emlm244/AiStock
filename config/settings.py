...
class Settings:
    ...
    STRAT_MIN_TRADES_WEIGHTING = 10 # Min trades required within lookback for performance to influence weight significantly
    # Signal Aggregation
    ...
    RETRAINING_PERFORMANCE_THRESHOLD = 0.48 # Trigger retraining if ML strategy win rate drops below this % (0.0 to 1.0)
    RETRAINING_MIN_TRADES_THRESHOLD = 25 # Minimum ML trades before performance check triggers retraining (increased slightly)
