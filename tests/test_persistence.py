...
from aistock.persistence import (
    load_checkpoint,
...
from aistock.portfolio import Portfolio, Position
...
class PersistenceTests(unittest.TestCase):
    ...
    def test_risk_state_save_and_load(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(restored.last_reset_date, date(2024, 7, 9))
