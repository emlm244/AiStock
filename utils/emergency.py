...
class EmergencyShutdownHandler:
    ...
    def execute_emergency_shutdown(
        ...
        try:
            ...
            success = self._execute_shutdown_steps(
                trading_bot,
    ...
    def _execute_shutdown_steps(
        ...
        try:
            if hasattr(trading_bot, 'api') and trading_bot.api:
                if trading_bot.api.is_connected():
...
class RecoveryManager:
    ...
    def perform_recovery_checks(self, trading_bot) -> tuple[bool, list[str]]:
        ...
        if hasattr(trading_bot, 'api'):
            if not trading_bot.api.is_connected():
